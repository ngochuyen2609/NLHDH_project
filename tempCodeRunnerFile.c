...
int main() {
    ...
    while (1) {
        ...
        else if (strncmp(lenh, "kill ", 5) == 0) killTienTrinh(atoi(lenh + 5));
        else if (strncmp(lenh, "stop ", 5) == 0) dungTienTrinh(atoi(lenh + 5));
        else if (strncmp(lenh, "resume ", 7) == 0) tiepTucTienTrinh(atoi(lenh + 7));
